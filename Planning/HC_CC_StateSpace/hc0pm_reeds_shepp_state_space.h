#ifndef HC0PM_REEDSSHEPPSTATESPACE_H
#define HC0PM_REEDSSHEPPSTATESPACE_H
...
class HC0PM_ReedsSheppStateSpace : public HC_CC_StateSpace
{
public:
    /**
     ...
     */
    HC0PM_ReedsSheppStateSpace(double kappa, double sigma, double discretization = 0.1);

    /**
     * @brief Destructor
     */
    virtual ~HC0PM_ReedsSheppStateSpace() override;
     ...
     */
    HC_CC_RS_Path* HC0PM_CirclesReedsSheppPath(HC_CC_Circle &c1, HC_CC_Circle &c2) const;
     ...
     */
    HC_CC_RS_Path* HC0PM_ReedsSheppPath(const State &state1, const State &state2) const;
...
private:
     ...
     */
    class HC0PM_ReedsShepp;

    /**
     * @brief unique pointer on class with families
     */
    unique_ptr<HC0PM_ReedsShepp> _hc0pm_reeds_shepp;
...
#endif // HC0PM_REEDSSHEPPSTATESPACE_H
