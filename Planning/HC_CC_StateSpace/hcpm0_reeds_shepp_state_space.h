#ifndef HCPM0_REEDSSHEPPSTATESPACE_H
#define HCPM0_REEDSSHEPPSTATESPACE_H
...
class HCPM0_ReedsSheppStateSpace : public HC_CC_StateSpace
{
public:
    /**
     ...
     */
    HCPM0_ReedsSheppStateSpace(double kappa, double sigma, double discretization = 0.1);

    /**
     * @brief Destructor
     */
    virtual ~HCPM0_ReedsSheppStateSpace() override;
     ...
     */
    HC_CC_RS_Path* HCPM0_CirclesReedsSheppPath(HC_CC_Circle &c1, HC_CC_Circle &c2) const;
     ...
     */
    HC_CC_RS_Path* HCPM0_ReedsSheppPath(const State &state1, const State &state2) const;
...
private:
     ...
     */
    class HCPM0_ReedsShepp;

    /**
     * @brief unique pointer on class with families
     */
    unique_ptr<HCPM0_ReedsShepp> _hcpm0_reeds_shepp;
...
#endif // HCPM0_REEDSSHEPPSTATESPACE_H
