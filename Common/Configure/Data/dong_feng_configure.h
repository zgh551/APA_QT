/*
 * dong_feng_configure.h
 *
 *  Created on: 2019年3月26日
 *      Author: Henry Zhu
 */

#ifndef DONG_FENG_CONFIGURE_H_
#define DONG_FENG_CONFIGURE_H_

#include "common_configure.h"
/****************** 车辆信息 ******************/
// 长度(m)
#define LENGHT                            (4.986f)
// 宽度(m)
#define WIDTH                             (1.861f)
// 高度(m)
#define HEIGHT                            (1.513f)
// 轴距(m)
#define WHEEL_BASE                        (2.850f)
// 车辆边沿到车辆中心点的距离(m)
#define FRONT_EDGE_TO_CENTER              (3.886f)
#define REAR_EDGE_TO_CENTER               (1.10f)
#define LEFT_EDGE_TO_CENTER               (0.9275f)
...
// 轮脉冲比例系数
#define WHEEL_PUSLE_RATIO                (0.0205)
...
/****/
#define WHEEL_PUSLE_MAX                  (1023)
/*** turn radius and the steering angle relationship ***/
// (400,470]
#define FIT_RADIUS_A1 		( 0.07466f)
#define FIT_RADIUS_B1 		(-4.072f)

// (300,400]
#define FIT_RADIUS_A2 		( 0.06758f)
#define FIT_RADIUS_B2 		(-1.289f)

// (200,300]
#define FIT_RADIUS_A3 		( 0.0653f)
#define FIT_RADIUS_B3 		(-0.5621f)

// (100,200]
#define FIT_RADIUS_A4 		( 0.06206f)
#define FIT_RADIUS_B4 		( 0.06662f)

// (50,100]
#define FIT_RADIUS_A5 		( 0.06312f)
#define FIT_RADIUS_B5 		(-0.02795f)

// (0,50]
#define FIT_RADIUS_A6 		( 0.062f  )
#define FIT_RADIUS_B6 		( 0.0f    )

// (-50,0)
#define FIT_RADIUS_A7 		( 0.062f  )
#define FIT_RADIUS_B7 		( 0.0f    )

// (-100,-50]
#define FIT_RADIUS_A8 		( 0.06123f)
#define FIT_RADIUS_B8 		(-0.02889f)

// (-200,-100]
#define FIT_RADIUS_A9 		( 0.06356f)
#define FIT_RADIUS_B9 		(-0.2489f)

// (-300,-200]
#define FIT_RADIUS_A10 		( 0.06393f)
#define FIT_RADIUS_B10 		(-0.3534f)

// (-400,-300]
#define FIT_RADIUS_A11 		( 0.06846f)
#define FIT_RADIUS_B11 		(-1.662f)

// (-510,-400]
#define FIT_RADIUS_A12 		( 0.06652f)
#define FIT_RADIUS_B12 		(-1.586f)
...
#define ACC_ARRAY_NUM  		( 12 )
#define VELOCITY_ARRAY_NUM  (  7 )

const float acc_table[ACC_ARRAY_NUM]           = {0.06f,0.09f,0.1f,0.12f,0.13f,0.15f,0.2f,0.21f,0.24f,0.26f,0.52f,0.58f};
...
const float torque_table[ACC_ARRAY_NUM][VELOCITY_ARRAY_NUM]=
{
        ...
        {540,480,440,400,360,300,280},
        {800,650,620,580,520,500,460}
};
